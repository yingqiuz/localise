...
from localise.prepare_masks import (
    ...
    def test_process_aparc_mgz_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with patch.dict(os.environ, {'FREESURFER_HOME': '/usr/local/freesurfer'}):
                with patch('localise.prepare_masks.run_fsl_command') as mock_run:
...
class TestCommandExecution:
    ...
    def test_execute_commands_with_queue(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with patch('localise.prepare_masks.check_fsl_sub_queues', return_value=True):
                with patch('localise.prepare_masks.run_fsl_command') as mock_run:
    ...
    def test_execute_commands_without_queue(self):
        ...
        with patch('localise.prepare_masks.check_fsl_sub_queues', return_value=False):
...
class TestMainFunction:
    ...
    def test_create_masks_success(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with patch('localise.prepare_masks.check_fsl_environment', return_value='/usr/local/fsl'):
                with patch('localise.prepare_masks.get_resources_path', return_value='/path/to/resources'):
                    with patch('localise.prepare_masks.process_aparc_file', return_value=str(aparc_file)):
                        with patch('localise.prepare_masks.execute_commands', return_value="job_123"):
                            with patch('localise.prepare_masks.create_scpct_masks', return_value=None):
    ...
    def test_create_masks_unsupported_structure(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with patch('localise.prepare_masks.check_fsl_environment'):
                with patch('localise.prepare_masks.get_resources_path'):
...
class TestMainEntryPoint:
    ...
    def test_main_success(self):
        ...
        with patch('localise.prepare_masks.parse_arguments') as mock_parse:
            mock_args = Mock()
            ...
            with patch('localise.prepare_masks.create_masks') as mock_create:
                main()
...
class TestIntegration:
    ...
    def test_full_workflow_mock(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with patch('localise.prepare_masks.check_fsl_environment', return_value='/usr/local/fsl'):
                with patch('localise.prepare_masks.get_resources_path', return_value='/path/to/resources'):
                    with patch('localise.prepare_masks.run_fsl_command'):
                        with patch('localise.prepare_masks.check_fsl_sub_queues', return_value=False):
